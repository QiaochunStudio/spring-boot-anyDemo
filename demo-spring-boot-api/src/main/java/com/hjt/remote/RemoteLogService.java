...
import com.hjt.factory.RemoteLogFallbackFactory;
 ...
 * @author hjt
 */
@FeignClient(contextId = "remoteLogService", value = ServiceNameConstants.HJT_PLATFORM_SYSTEM, fallbackFactory = RemoteLogFallbackFactory.class)
